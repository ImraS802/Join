...
export class Summary {
  ...
  async createContactObject(uid: string) {
    this.authService.contact.surname = this.authService.correctInput(
      this.authService.contact.surname,
    );
    this.authService.contact.lastname = this.authService.correctInput(
      this.authService.contact.lastname,
    );
    this.authService.contact.color = this.contactService.getRandomColor();

    setTimeout(() => {
      this.authService.currentUserName =
        this.authService.contact.surname + ' ' + this.authService.contact.lastname;
    }, 0);
